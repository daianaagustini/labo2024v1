...
envg$EXPENV <- list()
envg$EXPENV$exp_dir <- "~/buckets/b1/exp/F5"
...
HT_tuning_baseline <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    num_leaves = c( 500L, 2000L,  "integer" ),
    min_data_in_leaf = c( 700L, 1500L, "integer" )
  )
...
corrida_baseline_semillerio_202109( "basem05" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_baseline_semillerio_202107( "basem05b" )
