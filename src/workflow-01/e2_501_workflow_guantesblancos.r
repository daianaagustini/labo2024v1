...
HT_tuning_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$lgb_param <- list(
    ...
    is_unbalance = FALSE, #
    scale_pos_weight = c(1L, 99L, "integer"), # scale_pos_weight > 0.0
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002b", "FE0002" )

  HT_tuning_guantesblancos( "HT0002b", "TS0002b" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002b", c("HT0002b", "TS0002b") )
...
corrida_guantesblancos_202109( "gb02" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02b" )
